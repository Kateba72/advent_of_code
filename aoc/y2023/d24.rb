...
module AoC
  module Y2023
    class D24 < Solution
      ...
      def part1
        range = testing? ? 7..27 : 200_000_000_000_000..400_000_000_000_000
        ...
        hailstones.each_with_index do |hs_a, index_a|
          hailstones.each_with_index do |hs_b, index_b|
            ...
            intersections += 1 if intersection && range.cover?(intersection[0]) && range.cover?(intersection[1])
          end
        end
      ...
      def check_vel(vel, hs_a, hailstones)
        ...
        hailstones.each do |hs_b|
          ...
          return false unless first_pos # no intersection => invalid velocity
